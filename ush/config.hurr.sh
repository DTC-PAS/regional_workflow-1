...
# Note that there are both 13km and 3km HAFS grids.
# These have been adjusted to focus on the track of Florence.
...
# season cases.
DATE_FIRST_CYCL="20180828"
DATE_LAST_CYCL="20180828"
CYCL_HRS=( "00" )
