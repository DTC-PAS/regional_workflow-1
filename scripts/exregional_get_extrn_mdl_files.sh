...
if [ "${ICS_OR_LBCS}" = "ICS" ]; then
  ...
  input_file_path=${EXTRN_MDL_SOURCE_BASEDIR_ICS:-$EXTRN_MDL_SYSBASEDIR_ICS}/${extrn_mdl_cdate}/00
  ...
  input_file_path=${EXTRN_MDL_SOURCE_BASEDIR_LBCS:-$EXTRN_MDL_SYSBASEDIR_LBCS}/${extrn_mdl_cdate}/00
fi
